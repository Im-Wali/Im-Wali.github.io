...
## 식별자 종류 - 후보 식별자
  * 후보 식별자는 주 식별자가 될 가슨ㅇ성이 있는 식별자를 의미한다. 모든 식별자는 주 식별자가 될 수 있는 후보이므로, 식별자와 후보 식별자는 사실상 동일어다.
...
## 식별자 종류 - 슈퍼 식별자
  ...
  * 슈퍼 식별자를 구성하고 있는 속성 중에서 새로운 인스턴스를 생성하는데 영향을 미치지 않는 속성을 제외하면 후보 식별자가 된다. 최속 속성으로 이루어진 슈퍼 식별자가 후보 식별다.
